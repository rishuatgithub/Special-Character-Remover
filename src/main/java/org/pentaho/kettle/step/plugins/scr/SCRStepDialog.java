 ...
 * 
 */
public class SCRStepDialog extends BaseStepDialog implements StepDialogInterface{
	
	private static Class<?> PKG = SCRStepMeta.class;   // for il8n purposes

	private SCRStepMeta meta;
	...
	public SCRStepDialog(Shell parent, Object in, TransMeta transMeta, String sname) {
	...
	public String open() {
		...
		shell.setText(BaseMessages.getString(PKG, "SCRMeta.Shell.Title"));
		...
		wlValName.setText(BaseMessages.getString(PKG,"SCRMeta.FieldName.Label"));
		...
		inputDrop.setText(BaseMessages.getString(PKG,"SCRMeta.FieldNum.Label"));
		...
		algoBox.setText(BaseMessages.getString(PKG,"SCRMeta.Algo.Label"));
		...
		customLabel.setText(BaseMessages.getString(PKG,"SCRMeta.AlgoExe.Label"));
